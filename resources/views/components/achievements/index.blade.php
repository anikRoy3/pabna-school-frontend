<section class="flex lg:flex-row flex-col justify-between gap-4 mt-5 container mx-auto">
    ...
    <div class="w-full md:w-1/2 p-4 md:p-6 lg:p-[4em]"
        style="flex:60%; border-radius: 5px; border: 1px solid #F1F1F1; background: var(--white, #FFF); box-shadow: 0px 1px 1px 0px rgba(0, 0, 0, 0.25);">
