...
<section class="container mx-auto">
    <section>
        ...
        <div id="teachers_day_container" class="grid grid-cols-2 lg:grid-cols-5 gap-3" style="flex: 70%;
                                                   border-radius: 5px;
...
background: var(--white, #FFF);
height: 400px">
                <img style="height: 230px;" src="src/assests/teachersAndStaff_images/image_1.png" alt="Shoes" class="p-2 rounded-xl" />
                <h2 class="">মোঃ আলমগীর হোসেন তালুকদার</h2>
                <small>সহযোগী অধ্যাপক</small>
                <small>পিএইচডি বাংলা ভাষা</small>
...
background: var(--white, #FFF);
height: 400px">
                <img style="height: 230px;" class="p-2 rounded-xl" src="src/assests/teachersAndStaff_images/image_2.png" alt="">
                <h2 class="">মাফরুজা আক্তার </h2>
                <small>সহযোগী অধ্যাপক</small>
                <small>পিএইচডি বাংলা ভাষা</small>
                <div class="flex justify-between items-center w-full p-3">
                    <button style="border-radius: 5px; padding: 5px; background: var(--blue-1, #0C1167); color: white; display: flex; height: 30px; justify-content: center; align-items: center; gap: 5px;">
...
background: var(--white, #FFF);
height: 400px">
                <img style="height: 230px;" class="p-2 rounded-xl" src="src/assests/teachersAndStaff_images/image_3.png" alt="">
                <h2 class="">সুলতানা রনক জাহান</h2>
                <small>সহযোগী অধ্যাপক</small>
                <small>পিএইচডি বাংলা ভাষা</small>
                <div class="flex justify-between items-center w-full p-3">
                    <button style="border-radius: 5px; padding: 5px; background: var(--blue-1, #0C1167); color: white; display: flex; height: 30px; justify-content: center; align-items: center; gap: 5px;">
...
background: var(--white, #FFF);
height: 400px">
                <img style="height: 230px;" class="p-2 rounded-xl" src="src/assests/teachersAndStaff_images/image_4.png" alt="">
                <h2 class="">কণিকা রায়</h2>
                <small>সহযোগী অধ্যাপক</small>
                <small>পিএইচডি বাংলা ভাষা</small>
                <div class="flex justify-between items-center w-full p-3">
                    <button style="border-radius: 5px; padding: 5px; background: var(--blue-1, #0C1167); color: white; display: flex; height: 30px; justify-content: center; align-items: center; gap: 5px;">
...
background: var(--white, #FFF);
height: 400px">
                <img style="height: 230px;" class="p-2 rounded-xl" src="src/assests/teachersAndStaff_images/image_5.png" alt="">
                <h2 class="">সালমা আক্তার</h2>
                <small>সহযোগী অধ্যাপক</small>
                <small>পিএইচডি বাংলা ভাষা</small>
                <div class="flex justify-between items-center w-full p-3">
                    <button style="border-radius: 5px; padding: 5px; background: var(--blue-1, #0C1167); color: white; display: flex; height: 30px; justify-content: center; align-items: center; gap: 5px;">
...
height: 400px">
    ...
    <section class="mt-9" style="border-radius: 5px;
border: 1px solid #F1F1F1;
background: var(--white, #FFF);
box-shadow: 0px 1px 1px 0px rgba(0, 0, 0, 0.25);">
        <h3 class="p-4 text-center text-[1.5em]">শিক্ষক ও কর্মচারী (প্রভাতী শাখা)</h3>
        <div id="teachers_morning_container" class="grid grid-cols-2 lg:grid-cols-5 gap-3" style="flex: 70%;
                                                   border-radius: 5px;
                                                   border: 1px solid #F1F1F1;
                                                   background: var(--white, #FFF);
                                                   padding: 1em;
